window.OTT_CONFIG = {
  ...
  rails: [
    { title: "Trending Now", items: ["free", "tmkoc", "asiacup", "blackmail"] },
    { title: "Encrypted DASH", items: ["free", "output_2min", "output_02_04"] },
    { title: "Comedy", items: ["tmkoc", "blackmail"] },
    { title: "Sports", items: ["asiacup", "free"] },
    { title: "Continue Watching", items: ["free", "tmkoc", "output_2min"] }
  ]
};
